...
| Bridge trace/event-log format | Implemented; tests verified | `logging_utils.py` and `hermes_temi_bridge/README.md` | Bridge | Maintainers and `tools/show_temi_trace.py` | `test_trace_logging.py` | Writer, viewer, tests, README and retention/privacy policy |
