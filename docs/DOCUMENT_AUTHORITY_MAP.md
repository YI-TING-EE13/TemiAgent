...
Status: <code>CURRENT_AUTHORITY</code>; Gate 5 final evidence inventory
reviewed: 2026-08-29.
...
submodule contents. The Gate 5 final evidence candidate has
...
| <code>AGENTS.md</code> | CURRENT_AUTHORITY | Repository governance, safety and collaboration rules. | Agent permissions, container boundary, protected files and delivery rules. | Root README and operational safety policy. | None after Gate 5 final evidence adoption; executable policy still wins. | Keep required reading; change only through governance review. |
...
| <code>README.md</code> | CURRENT_AUTHORITY | Repository entrypoint, scope and module map. | Project identity, capability limits and first reading route. | Current status, repository map and student handover. | None after Gate 5 final evidence adoption. | Link the current setup and handover entry points. |
...
| <code>docs/CURRENT_STATUS.md</code> | CURRENT_AUTHORITY | Dated implementation, evidence and publication status snapshot. | Current/verified/external/experimental/host-live/live-unverified claims. | README, repository map and release record. | None after Gate 5 final release and candidate status correction. | Refresh only when evidence or publication state changes. |
...
| <code>docs/REPOSITORY_MAP.md</code> | CURRENT_AUTHORITY | High-density source, generated and runtime boundary map. | Repository layout and publication boundary. | README and current status. | None after Gate 5 final link/status update. | Update when source ownership or external pins change. |
