...
| `operations/lmstudio_headless_3gpu_hdd_manual.md` | Headless LM Studio 使用 `/TemiAgent/.lmstudio-data`、預設 QAT virtual model `temi/gemma-4-31b-it-qat`、API identifier `google/gemma-4-31b`、64K context、支援單卡、雙卡、三卡 GPU 組合的啟動/換模型/debug 手冊。 |
