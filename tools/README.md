...
2026-07-29 真機 ASR 曾將「手部運動」完整轉寫為「首都運動」或「守護運動」。
`hermes_media_fast_path.py` 只為這兩個完整、已驗收的 ASR transcript 增加 exact alias，仍固定
到 `elderly_hand_exercise`；它不做模糊比對、語意改寫或任意影片搜尋。
